...
interface Ajuste { papel: PapelHii; provider: string; model: string; etag: string; chave: string }
export default defineEventHandler(async event => {
  ...
  if (!b || !['implement', 'step', 'verify', 'gate'].includes(b.papel) || typeof b.provider !== 'string' ||
    typeof b.model !== 'string' || b.model.length > 200 || typeof b.etag !== 'string' ||
  ...
  try {
    return await cliente.configurar({ versao: 1, papel: b.papel, provider: b.provider, model: b.model }, b.chave, b.etag)
  } catch (e) {
