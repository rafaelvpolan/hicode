...
import { rotuloDaEtapa } from '#shared/observabilidade'
...
.motor{padding:24px 0}.titulo{display:flex;justify-content:space-between;align-items:center;gap:24px;margin-bottom:28px}.titulo h1{font-size:30px;margin:4px 0}.eyebrow,.conexao{font:12px monospace;letter-spacing:.06em}.conexao{border:1px solid var(--hairline-forte);padding:8px 12px;border-radius:20px}.entrada,.pedido{padding:20px;border:1px solid var(--hairline);border-radius:8px;margin-bottom:24px}.pedido{display:flex;flex-wrap:wrap;gap:16px;align-items:end}label{display:flex;flex-direction:column;gap:8px;font-size:13px}.texto{flex-basis:100%}input,select,textarea{font:inherit;padding:10px;background:transparent;color:inherit;border:1px solid var(--hairline-forte);border-radius:5px}option{color:var(--texto);background:var(--superficie)}button{font:inherit;padding:10px 16px;cursor:pointer;border:1px solid var(--hairline-forte);border-radius:5px;background:transparent;color:inherit}button:disabled{opacity:.5;cursor:default}button:focus-visible,input:focus-visible,textarea:focus-visible,select:focus-visible{outline:2px solid var(--acento);outline-offset:3px}.colunas{display:grid;grid-template-columns:minmax(260px,1fr) minmax(300px,1.2fr);gap:28px}.arvore,.detalhe{min-width:0}.atividade{display:flex;flex-wrap:wrap;align-items:center;gap:9px;width:100%;text-align:left;border-radius:0;border-width:0 0 1px;padding-block:14px}.atividade small{width:100%;color:var(--texto-mudo)}.selecionada{background:var(--acento-veu)}.estado{font:11px monospace;padding:3px 6px;border:1px solid var(--hairline-forte);border-radius:3px}.estado[data-estado=failed]{color:var(--falha)}.estado[data-estado=running]{color:var(--acento)}dl{font-size:13px}dt{color:var(--texto-mudo);margin-top:14px}dd{margin:4px 0;overflow-wrap:anywhere}.saida,.resposta{white-space:pre-wrap;overflow-wrap:anywhere;font:12px/1.6 monospace;padding:15px;border:1px solid var(--hairline);border-radius:5px;max-height:360px;overflow:auto}.saida small{color:var(--texto-mudo)}.acoes{display:flex;flex-wrap:wrap;gap:8px;margin-top:20px}.alerta{border-left:3px solid var(--atencao);padding:12px}h2{font-size:18px}h3{font-size:16px}@media(max-width:800px){.colunas{grid-template-columns:1fr}.titulo{align-items:start;flex-direction:column}.pedido label{width:100%}}
</style>
