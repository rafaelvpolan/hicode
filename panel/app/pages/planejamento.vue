...
<template>
  <main class="planejamento">
    ...
    <template v-if="habilitado">
      ...
      <div v-if="documento.epico" class="acoes"><button :disabled="ocupado" @click="salvar(false)">Salvar epico e tarefas</button><p>Progresso de execucao ainda nao verificado. Salvar a proposta nao conclui criterios nem despacha tarefas.</p></div>
