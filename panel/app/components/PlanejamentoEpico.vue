...
<style scoped>
fieldset{border:0;padding:0}.grade{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:16px}label{display:flex;flex-direction:column;gap:8px;margin:12px 0;font-size:14px}input,textarea,select,button{font:inherit;padding:10px;background:transparent;color:inherit;border:1px solid var(--hairline-forte);border-radius:5px}option{color:var(--texto);background:var(--superficie)}article{border-top:1px solid var(--hairline-forte);margin-top:24px;padding-top:16px}small{display:block;font:11px monospace;overflow-wrap:anywhere;opacity:.6}.acoes{display:flex;flex-wrap:wrap;gap:8px;margin-bottom:20px}button{cursor:pointer}button:disabled{opacity:.5;cursor:default}input:focus-visible,textarea:focus-visible,select:focus-visible,button:focus-visible{outline:2px solid var(--acento);outline-offset:3px}@media(max-width:600px){.grade{grid-template-columns:1fr}}
</style>
