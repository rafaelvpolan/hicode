...
import { motivoDeInelegibilidade } from '#shared/configuracao-hii'
...
<style scoped>
.configuracao{border:1px solid #65716a;border-radius:8px;padding:16px;margin-bottom:20px}summary{cursor:pointer;font-weight:600}form{display:flex;flex-wrap:wrap;gap:16px;align-items:end}label{display:flex;flex-direction:column;gap:8px;min-width:180px}p{flex-basis:100%;font-size:13px;overflow-wrap:anywhere}input,select,button{font:inherit;padding:10px;background:transparent;color:inherit;border:1px solid #65716a;border-radius:5px}option{color:#111}button{cursor:pointer}button:disabled{opacity:.5;cursor:default}input:focus-visible,select:focus-visible,button:focus-visible{outline:2px solid #76d8ad;outline-offset:3px}@media(max-width:600px){label{width:100%;min-width:0}input,select{max-width:100%}}
</style>
